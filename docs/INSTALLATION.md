...
Download `codex-claude-mcp-v0.1.0.zip`, its `.sha256` file, and the CycloneDX SBOM from the [v0.1.0 release](https://github.com/Cyruskraad/codex-claude-mcp/releases/tag/v0.1.0). Verify the checksum:

```sh
shasum -a 256 -c codex-claude-mcp-v0.1.0.zip.sha256
```
