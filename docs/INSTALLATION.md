...
Download `codex-claude-mcp-v0.1.1.zip`, its `.sha256` file, and the CycloneDX SBOM from the [v0.1.1 release](https://github.com/Cyruskraad/codex-claude-mcp/releases/tag/v0.1.1). Verify the checksum:

```sh
shasum -a 256 -c codex-claude-mcp-v0.1.1.zip.sha256
```
